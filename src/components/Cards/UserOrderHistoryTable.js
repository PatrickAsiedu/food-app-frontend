...
import { formatDateToDateString, formatDateToDateAndTimeString } from "../../utils/util-functions";
...
const UserOrderHistoryTable = () => {
  ...
  return (
      <React.Fragment>
        {orders ? (<div className=" hidden lg:flex lg:px-[90px] 2xl:px-[200px] text-primary" >
