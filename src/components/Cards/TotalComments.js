...
const TotalComments = (props) => {
  return (
    <div className="w-full  lg:w-[200px] xl:w-[240px]   2xl:w-[320px] h-[180px] box-outer-shadow rounded-3xl flex flex-col pl-9  justify-evenly ">
      <svg
        width="31"
        height="31"
        viewBox="0 0 31 31"
      ...
      <h1 className=" ">Total Comments</h1>
