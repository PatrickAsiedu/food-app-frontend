...
const EnterNewPasswordModalForm = () => {
  ...
  return (
    <React.Fragment>
      ...
      ></div>
      <div className="absolute top-[12%] left-[40%] bg-white  z-20 w-[600px]  box-outer-shadow px-12 rounded-3xl  text-primary">
        <button onClick={onCloseModalHandler} className="mt-4 float-right">
          <svg
