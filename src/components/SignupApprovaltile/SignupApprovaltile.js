      ...
      <div className=" flex  flex-col">
        <div className="flex text-base font-medium items-center ">
          ...
          <div className="ml-4 leading-8">
            ...
            <span className="ml-4">signed up with name </span>
            <span className="ml-4">David Dag Vanderpuijek</span> on
...
export default SignupApprovaltile;
