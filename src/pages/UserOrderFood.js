    ...
    <React.Fragment>
      <div className=" lg:flex h-screen ">
        <div className=" lg:pl-8 lg:h-full lg:border-r-2  lg:w-[30%] 2xl:w-[20%] lg:fixed ">
          ...
          <nav className=" hidden lg:flex lg:flex-col  height-calc mt-24 flex flex-col justify-between">
            <div>
              <a className=" group flex items-center py-6 pl-6 hover:bg-primary  ">
                ...
                <span className=" ml-5 font-semibold text-primary opacity-80 group-hover:text-white group-hover:opacity-100 group-hover:font-light  ">
                  Dashboard
                </span>
              </a>
        ...
        <main className="hidden lg:flex flex-col md:ml-[30%] 2xl:ml-[20%]  w-[70%]  2xl:w-[80%] ">
          ...
          <OrderLunchForm devicestatus={""}></OrderLunchForm>
        </main>
      </div>
    </React.Fragment>
  );
